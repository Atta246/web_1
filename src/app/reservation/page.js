                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    {formStatus.error && formStatus.message.includes('largest table') && (
                      <div className="mt-2">
                        <a href="tel:+15551234567" className="text-indigo-600 dark:text-indigo-400 underline hover:text-indigo-800 font-medium">Call us at (555) 123-4567</a> to arrange accommodations for larger groups.
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start transform hover:scale-[1.01] transition-transform">
                  ...
                  <div className="ml-5">
                    ...
                    <a href="tel:+15551234567" className="inline-flex items-center mt-2 text-indigo-600 dark:text-indigo-400 hover:text-purple-600 dark:hover:text-purple-400 font-medium transition-colors">
